...
l1.place(x=150,y=10)
l2 = Label(win , text='My name is Intelligent Calculator', width=30, padx=3)
l2.place(x=140,y=40)
l3 = Label(win , text='What can i help you?' , padx=3)
l3.place(x=176,y=130)


l4 = Label(win , text='Developed by Shivant kumar Pandey',width=40, padx=4)
l4.place(x=90,y=100)
...
list = Listbox(win,width=40,height=4)
list.place(x=90,y=250)
